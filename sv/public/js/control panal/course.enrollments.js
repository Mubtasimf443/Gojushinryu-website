    ...
    async function orgTable() {
        ...
        main_table.querySelectorAll('button').forEach(function(element) {
            element.addEventListener('click', function (event = new Event('click')) {
                ...
                inputs[0].value = course.student_id;
                inputs[1].value = course.student_name;
                inputs[2].value = course.student_phone;
                inputs[3].value = course.student_email;
                inputs[4].value = (course.student_postcode + ',' + course.student_address);
                inputs[5].value = course.student_dob;
                inputs[6].value = course.student_sex;
                inputs[7].value = course.additional_details?.hasViolence;
                inputs[8].value = course.additional_details?.hasBadMedical;
                inputs[9].value = course.additional_details?.hasDisability;
                inputs[10].value = course.additional_details?.student_signature;
                inputs[11].value = course.additional_details?.student_parants_signature;
